...
export default function CodeOfConductPage() {
  return (
    <main className="overflow-x-hidden bg-[#030712] text-slate-100 antialiased selection:bg-cyan-500/30 selection:text-white">
      ...
      <PageBackground>
        {/* ================= HERO CONTAINER WITH PERFECT ASYMMETRIC ALIGNMENT ================= */}
        <section className="relative pt-56 pb-40 px-6 md:px-12 xl:px-20 max-w-[1650px] mx-auto min-h-[85vh] flex flex-col justify-center">
          {/* HEADER ROW: Spans cleanly across the top block */}
          ...
          {/* SPLIT CONTENT ROW: Text content block and PDF card perfectly match heights side-by-side */}
          <div className="grid gap-8 lg:grid-cols-12 items-stretch w-full">
            {/* LEFT 7-COLUMNS: CORE TEXT SUMMARY */}
            <div className="lg:col-span-7 relative p-8 rounded-2xl border border-white/10 bg-slate-950/60 backdrop-blur-xl shadow-xl space-y-5 flex flex-col justify-center text-left">
              ...
              <p className="text-sm md:text-base leading-relaxed text-slate-300">
                Mar Baselios Dental College (MBDC) is a distinguished
                professional dental institution established with a goal of
                imparting quality dental education and state-of-art dental care.
                The mission and vision of the college reflects the commitment of
                the college in attaining the above goal.
              </p>
              <p className="text-sm md:text-base leading-relaxed text-slate-300">
                This can only be realized with the dedicated and concerted
                efforts of the faculty, non-teaching staff, and students of the
                college. The following code of conduct intends to provide
                guidance to all concerned while carrying out their day to day
                responsibilities in the college. All shall adhere to the same at
                all times to uphold the core values, reputation, and noble
                traditions of the college.
              </p>
            </div>

            {/* RIGHT 5-COLUMNS: MATCHED PDF HANDBOOK BOX */}
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <p className="text-sm text-slate-400 leading-relaxed mt-2">
                      Review the institutional parameters, operations, and
                      guidelines structured for all associated components.
                    </p>
                  </div>
                </div>

                {/* Main Action Component - Anchored precisely to match the left section's baseline */}
                <div className="mt-6 pt-4">
                  <a
                    href="/assets/code-of-conduct.pdf"
                    target="_blank"
