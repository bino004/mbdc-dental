...
export default function DentalMechanicsPage() {
  return (
          ...
          <header className="relative z-10 border-b border-white/10 pb-20 mb-10 text-left">
            <motion.div variants={itemVariants}>
              ...
              <p className="max-w-2xl text-lg md:text-xl text-slate-400 leading-relaxed border-l-2 border-cyan-500/50 pl-6">
                Official academic guidelines, syllabus structures, and
                regulatory admission parameters for the Dental Mechanics
                program.
              </p>
            </motion.div>
          </header>
            ...
            >
              ...
              <div className="space-y-4 text-[15px] md:text-base text-slate-300 leading-relaxed">
                ...
                <ul className="space-y-3 pl-4 border-l-2 border-white/10">
                  <li>
                    <strong className="text-white">Primary:</strong> (i) Applied
                    Physics, Chemistry and Mechanics, (ii) Dental Mechanics,
                    (iii) Applied Oral Anatomy.
                  </li>
                  <li>
                    <strong className="text-white">Final:</strong> (i) Dental
                    Mechanics, (ii) Dental materials and metallurgy, (iii) Basic
                    knowledge of Computer and Medical Records Management.
                  </li>
                </ul>
                <p className="pt-2">
          ...
          >
            ...
            <div className="p-10 md:p-14 rounded-[2.5rem] bg-gradient-to-br from-cyan-900/50 to-indigo-950/50 border border-cyan-500/20 flex flex-col justify-center shadow-2xl">
              ...
              <p className="mb-10 text-[15px] md:text-lg text-slate-300 leading-relaxed">
                Access the official fee ledger for the Dental Mechanics program
                and download the complete paramedical prospectus for detailed
                academic policies.
              </p>
